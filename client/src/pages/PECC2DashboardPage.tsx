      ...
      <Box sx={{ mt: isMobile ? 2 : 4 }}>
        ...
        <Box sx={{ mb: isMobile ? 3 : 4 }}>
          <Typography variant={isMobile ? "h4" : "h3"} gutterBottom color="primary">
            Welcome back, {userProfile?.firstName || 'PECC2'}!
          </Typography>
          <Typography variant={isMobile ? "body1" : "h6"} color="text.secondary" sx={{ mb: 2 }}>
            Your PECC2 Pediatric Readiness Dashboard
          </Typography>
          ...
          <Card sx={{ p: 2 }}>
            <CardContent>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 2, lineHeight: 1.4 }}>
                Welcome to your ImPACTS PECC2 Tracker! This dashboard is designed to guide you through your Pediatric Emergency Care Coordinator journey. Here's how to get started:
              </Typography>
...
export default PECC2DashboardPage;
