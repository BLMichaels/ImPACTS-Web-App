...
echo "Done. Functions: provision-crm-portal-user, complete-invitation-registration, send-invitation-email, admin-reset-user-mfa, admin-send-password-reset, request-password-reset, sync-portal-login-email (per supabase/functions/)."
